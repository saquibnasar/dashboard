        ...
        >
          {data.profileImage ? (
            <div
              className={
                data.bannerImages
                  ? `frame-container user-logo banner_image`
                  : "frame-container user-logo"
              }
            >
          ...
          <div className={data.bannerImages ? "banner_image" : ""}>
            ...
            <button
              type="button"
              className="save-my-contact-parent"
              onClick={() => {
                generateVCF();
              }}
            >
                ...
                {/* <div className="div-username-featuredlink-m1">
                  ...
                  <div className="youtube-player1">
                    ...
                    <div className="bottom-controls1">
                      ...
                      />
                      <img
                        className="ico-next-icon"
                        alt=""
                        src="/iconext1.svg"
                      />
                      <img
                        className="ico-play-icon1"
                        alt=""
                        src="/icoplay.svg"
                      />
